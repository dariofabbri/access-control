define([
	...
	"access-control/views/roles/roleslistitem",
	"access-control/views/roles/rolessearch",
	"text!templates/roles/roleslist.html"], 
	...
	var view = Backbone.View.extend({
		...
		addItem: function() {
			...
			Backbone.history.navigate("RolesNew", true);
		},
