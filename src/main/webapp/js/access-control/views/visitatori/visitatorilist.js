define([
	...
	"access-control/views/visitatori/visitatorilistitem",
	"access-control/views/visitatori/visitatorisearch",
	"text!templates/visitatori/visitatorilist.html"], 
