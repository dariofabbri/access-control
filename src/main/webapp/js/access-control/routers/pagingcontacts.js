define([
	"underscore", 
	"backbone",
	"access-control/views/pagingcontacts/pagingcontactslist",
	"access-control/views/pagingcontacts/pagingcontactsedit",
	"access-control/views/pagingcontacts/pagingcontactssearch",
	"access-control/models/contact",
	"access-control/collections/contacts"], 
	function(
			_, 
			Backbone, 
