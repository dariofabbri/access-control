...
public class QueryAccessoByStatoPassiDestinatarioAutorizzatoDaIngressoDaIngressoAUscitaDaUscitaANomeVisitatoreCognomeVisitatore extends Query<Accesso> {
	...
	public QueryAccessoByStatoPassiDestinatarioAutorizzatoDaIngressoDaIngressoAUscitaDaUscitaANomeVisitatoreCognomeVisitatore(Session session) {
